<div>
                    ...
                    <div class="card-body">								
                        <table class="table table-hover text-nowrap">
                            ...
                            <tbody>
                             ...
                             <tr  id="category-row-{{$shipping->id}}">
                                <td>{{++$key}}</td>
                                ...
                                <td>
                                    ...
                                    <a href="#"  data-id="{{ $shipping->id }}" class="text-danger w-4 h-4 mr-1 delete_shipping">
    ...
    <script>
        ...
        var deleteUrl = "{{ route('Shipping.delete', ':id') }}".replace(':id', shippingId);
        deleteajax(shippingId, deleteUrl)
