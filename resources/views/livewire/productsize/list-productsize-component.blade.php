<div>
                    ...
                    <div class="card-body">								
                        <table class="table table-hover text-nowrap">
                            ...
                            <tbody>
                             ...
                             <tr  id="category-row-{{$productsize->id}}">
                                
                                <td>{{ $productsizes->firstItem() + $key }}</td>
                                ...
                                <td>
                                    ...
                                    <a href="#"  data-id="{{ $productsize->id }}" class="text-danger w-4 h-4 mr-1 delete_productSize">
    ...
    <script>
        ...
        $(".delete_productSize").on('click', function() {
        
           
        
        let sizeId = $(this).data('id');
        
        var deleteUrl = "{{ route('ProductSize.delete', ':id') }}".replace(':id', sizeId);
        deleteajax(sizeId, deleteUrl)
