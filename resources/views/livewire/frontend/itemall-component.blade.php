<div>
    ...
    <main>
        <div class="container-fluid custom-container">
          ...
          <div class="row">
            ...
            <!-- First Column (col-4) -->
            <div class=" col-12 col-sm-5 col-md-3 col-lg-2 custom-column ">
  
              <div class="card">
                <img src="../asset/image/07957cd0-f64e-4d8c-a15b-0731377b3e44.jpg" class="card-img-top" alt="..." height="200px">
                <div class="card-body">
                  <h6>single Brand Image</h6>
                  <p class="card-text">Thim less style</p>
            ...
            <!-- Second Column (col-8) -->
            <div class="col-12 col-sm-7 col-md-9 col-lg-10 custom-column mt">
              ...
              <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel hight">
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img src="../asset/image/carousel-2.jpg" class="d-block w-100 image-fluid" alt="...">
                  ...
                  <div class="carousel-item">
                    <img src="../asset/image/carousel-1.jpg" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-none d-md-block">
              ...
              <!-- owl curusol end -->
              <div>
                <span class="mt-3">Clothing And Accessories</span> <span>(Showing 1  40 products of 50,123 products)</span>
                ...
                <div>
                  ...
                  <div class="row">
                    ...
                    @foreach ($itemProduct->product as $product)
                    <div class="col-12 col-md-4 col-lg-3">
                      ...
                      <div class="card shadow">
                        ...
                        <div class="card-body">
                          <p class="card-text">Brand Name: <span class="brand-name">{{$itemProduct->name}}</span></p>
                  ...
                  <div class="row">
                    <div class="col-6 col-sm-12  col-md-4 col-lg-3 " id="">
                      <div class="card shadow">
                       <img src="../asset/image/07957cd0-f64e-4d8c-a15b-0731377b3e44.jpg" class="card-img-top" >
                        <div class="card-body">
                          <p class="card-text">ব্র্যান্ডের নাম: <span class="brand-name">আপনার ব্র্যান্ডের নাম</span></p>
                          <h5 class="card-title">পণ্যের নাম</h5>
                          <p class="card-text">মূল্য: <span class="price">পণ্যের মূল্য</span></p>
  ...
  <div class="container-fluid mt-2">
    <p>Realted Brand (Showing 40 brands of 50,123 brands)</p>
  
      <div class="owl-carousel owl-theme">
          <div class="item"> <div class="card h-100">
              <div class="row">
                <div class="col-4">
