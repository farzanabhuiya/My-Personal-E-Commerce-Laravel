<div>
                            ...
                            <tbody>
                             ...
                             <tr>
                                ...
                                <td>
                                    ...
                                    <a href="#"  data-id="{{ $productsize->id }}" class="text-danger w-4 h-4 mr-1 deleteBtn">
   ...
   $(".deleteBtn").on('click', function() {
                ...
                let productsizeId = $(this).data('id');
                var deleteUrl = "{{ route('ProductSize.delete', ':id') }}".replace(':id', productsizeId);
                deleteajax(productsizeId, deleteUrl)
