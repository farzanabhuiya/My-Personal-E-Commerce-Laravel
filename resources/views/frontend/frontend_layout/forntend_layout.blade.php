        ...
        <div class="container-fluid  ">
            ...
            <div class="row ">
                ...
                <span class="col-3   col-md-3  logo    ">
                    <img class="ml-2" src="{{asset('frontend/asset/image/07957cd0-f64e-4d8c-a15b-0731377b3e44.jpg')}}"
                        ...
                        <div class="profile  ">
                            ...
                            <div class="profile-dropdown ">
                                <a type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown"
                                    ...
                                    <img class="rounded-circle" src="{{asset('frontend/asset/image/cloth-2.jpg ')}}"
                                        alt="clouth" width="35px" height="35px">
    ...
    <div class="nav-manu ">
        ...
        <ul class="nav-links">
            ...
            <li class="menu-item">
                ...
                <a href="#" class="toggle-submenu">{{ Str::title($category->name)  }} <span class="arrow-icon"> <svg
                ...
                <ul class="submenu">
                    ...
                    <li><a class="dropdown-item"
                            href="{{route('frontend.contant.ProductSubcategory', [$Subcategorie->slug])}}">{{$Subcategorie->name}}</a>
                    </li>
                    @endforeach
                </ul>
            </li>
            ...
            <div class="row m-auto">
                <div class=" col-sm-6 col-md-4 col-lg-2">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="{{route('frontend.contant.page',$page->slug)}}" title=""
                        class="text-white">{{$page->name}}</a></li>
                        @endforeach --}}
                    </ul>
                </div>
                <div class=" col-sm-6  col-md-4 col-lg-2">
                ...
                <div class=" col-sm-6  col-md-4 col-lg-2">
                    ...
                    <div>
                        <p>
                            ...
                            Village,Outer Ring Road, Devarabeesanahalli Village,Bengaluru, 560103,Karnataka, India
                        </p>
