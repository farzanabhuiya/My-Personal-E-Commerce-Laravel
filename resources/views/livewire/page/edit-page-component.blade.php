<div>
 ...
 <section class="content">
     ...
     <div class="container-fluid">
         <form wire:submit="UpdatePage({{$id}})" method="post" >
             @csrf
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-6">
                         <div class="mb-3">
                             ...
                             <select value="{{$status}}" wire:model='status' id='status' class="form-control">
                     ...
                     <div class="col-md-12">
                         <div class="mb-3" wire:ignore>
                             ...
                             <textarea value="{{$content}}" wire:model='content'  id="content" placeholder="Content Goes Here...."></textarea>
                         </div>								
                     </div>                                    
                 </div>
             </div>							
